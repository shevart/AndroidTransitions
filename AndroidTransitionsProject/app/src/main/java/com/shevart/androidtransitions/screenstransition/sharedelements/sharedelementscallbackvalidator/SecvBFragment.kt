...
import com.shevart.androidtransitions.screenstransition.sharedelements.sharedelementscallbackvalidator.helper.validateSharedElementsTransition
...
class SecvBFragment : AbsFragment() {
...
//        }
    ...
    companion object {
        ...
        fun getInstance(simpleItem: SimpleItem) = SecvBFragment().apply {
